...
def downloadAndExtract():
    ...
    zipfile.extractall('/tmp/TropixeelLauncher/Minecraft')


def launch():
    res = T.get("1.0", "end")
    print(res)
    with open('/tmp/TropixeelLauncher/Minecraft/nick.txt', 'w') as f:
        f.write(T.get("1.0", "end"))
    mbox()
    downloadAndExtract()

    subprocess.call([r'/tmp/TropixeelLauncher/Minecraft/gs.sh'])
...
path = "/tmp/TropixeelLauncher/"
path9 = "/tmp/TropixeelLauncher/Minecraft/"
